<template>
  <div class="containter">
    <div class="trening">
      ...
      <p>
        • 5 treninga tjedno za cijelo tijelo: 2 za noge i gluteus, 3 za trbuh,
        ruke i leđa kod kuće
      </p>
      ...
      <p>
        • program sadržava i upute za zagrijavanje prije svakog treninga te
        istezanje nakon.
      </p>
...
export default {
  ...
  data() {
    return {
      Email: "",
      Password: "",
      odabir: "CIRKULARNI POLUSATNI PROGRAM",
      telefon: "",
    };
  },
  methods: {
